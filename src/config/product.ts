...
export const PLANS: Plan[] = [
  {
    ...
    bestFor: "Players who want unlimited titles after the five free starts.",
    benefits: ["Unlimited catalog after free play", "Ad-free sessions", "Standard frames", "1 extra continue per session"],
  },
  {
    id: "surge",
    name: "Surge",
